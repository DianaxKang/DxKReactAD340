...
import { FlatList, SectionList, StyleSheet, Text, View, SafeAreaView, StatusBar } from 'react-native';
...
const App = () => {
  return (
    ...
    <Text style={styles.title}> DxKReactAD340 </Text>
     ...
     This paragraph displays before a list of Romanian, Korean foods, and American foods.
     </Text>
